...
mechanic in the Betting section REFERENCE TODO, where the required cost will be calculated to allow the
game to end by getting an overall tendency towards zero.

Movement of the animals will be further discussed later in REFERENCE TODO. Problems like distribution
within the movement ranges, and who wins including if/when ties exist.
