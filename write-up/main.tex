...
well as ready for future expansion. Therefore, four custom structs (structured groups of data) as well as one
enum (list of structs sharing similar properties) are used for modularity, and their relationship as well as
...
\begin{table}[!ht]
	...
	\begin{tabular}{ | c c | }
		...
		\texttt{balance}  & \texttt{32}          \\
		\texttt{bet}      & \texttt{Bet}         \\ \hline
		\texttt{animals}  & \texttt{Vec<Animal>} \\ \hline
	\end{tabular}
